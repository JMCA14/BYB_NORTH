...
const _tablaMetroIngreso = (i, d, sec) => {
    ...
    const filas = window.METRO_DIAMS.map(dm => {
        ...
        return `<tr style="border-bottom:1px solid #dde1e7;">
            ...
            <td style="padding:2px 3px;"><input type="text" style="width:62px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.78em;box-sizing:border-box;" value="${v}" oninput="window.data[${i}]['${k}']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
            <td style="padding:2px 3px;"><input type="text" style="width:42px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.78em;box-sizing:border-box;" placeholder="Ej:J6" value="${va}" oninput="window.data[${i}]['${ka}']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
        </tr>`;
    }).join('');
    ...
    return `<div style="background:#fff;border:1px solid #c0d0e8;border-radius:6px;overflow:hidden;margin-bottom:8px;">
        ...
        <table style="width:100%;border-collapse:collapse;">
            ...
            <tr style="background:#eef2f8;">
                ...
                <td style="padding:2px 3px;"><input type="text" style="width:40px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.75em;box-sizing:border-box;" title="Tol. mín" value="${tolMin}" oninput="window.data[${i}]['${pref}_ing_tol_min']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
                <td style="padding:2px 3px;"><input type="text" style="width:40px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.75em;box-sizing:border-box;" title="Tol. máx" value="${tolMax}" oninput="window.data[${i}]['${pref}_ing_tol_max']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
            </tr>
...
const _tablaMetroSalida = (i, d, sec) => {
    ...
    const filas = window.METRO_DIAMS.map(dm => {
        ...
        return `<tr style="border-bottom:1px solid #dde1e7;">
            ...
            <td style="padding:2px 3px;"><input type="text" style="width:62px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.78em;box-sizing:border-box;" placeholder="mm" value="${vSal}" oninput="window.data[${i}]['${kiSal}']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
            <td style="padding:2px 3px;"><input type="text" style="width:42px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.78em;box-sizing:border-box;" placeholder="Ej:J6" value="${vSalAj}" oninput="window.data[${i}]['${kiSalAj}']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
        </tr>`;
    }).join('');
    ...
    return `<div style="background:#fff;border:1px solid #27ae60;border-radius:6px;overflow:hidden;margin-bottom:8px;">
        ...
        <table style="width:100%;border-collapse:collapse;">
            ...
            <tr style="background:#eef2f8;">
                ...
                <td style="padding:2px 3px;"><input type="text" style="width:40px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.75em;box-sizing:border-box;" title="Tol. mín" value="${tolMin}" oninput="window.data[${i}]['${pref}_sal_tol_min']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
                <td style="padding:2px 3px;"><input type="text" style="width:40px;padding:2px 4px;border:1px solid #bcd;border-radius:3px;font-size:0.75em;box-sizing:border-box;" title="Tol. máx" value="${tolMax}" oninput="window.data[${i}]['${pref}_sal_tol_max']=this.value;window.save()" onkeydown="if(event.key==='Enter'){event.preventDefault();this.blur();}"></td>
            </tr>
            <tr style="background:#f7f9fc;">
                        ...
                        return `<tr style="background:${val==='bueno'?'#eafff2':val==='malo'?'#fff5f5':rowBg};border-bottom:1px solid #dde1e7;">
                            ...
                            <td style="padding:4px 8px;">
                                <input type="text" value="${(ch.obs||'').replace(/"/g,'&quot;')}" placeholder="Observación..."
                                    ...
                                    oninput="window.guardarRevisionCheck(${i},'${it.k}','obs',this.value)"
                ...
                return `<div style="border:2px solid #e8a000;border-radius:10px;padding:14px 16px;margin-bottom:12px;background:#fffbf0;">
                    ...
                    ${puedeEditar ? `<div style="margin-bottom:8px;">
                        ...
                        <textarea style="width:100%;min-height:60px;padding:6px 8px;border:1px solid #ddc070;border-radius:5px;font-size:0.84em;resize:vertical;"
                            ...
                            oninput="window.guardarMecMedidas(${i},'${tw.k}',this.value)">${tj.medidas||''}</textarea>
                    </div>
